...
static inline MinnetFormParser* minnet_formparser_data(JSValueConst obj) { return JS_GetOpaque(obj, minnet_formparser_class_id); }

static inline MinnetFormParser* minnet_formparser_data2(JSContext* ctx, JSValueConst obj) { return JS_GetOpaque2(ctx, obj, minnet_formparser_class_id); }
