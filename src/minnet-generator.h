...
static inline MinnetGenerator* minnet_generator_data(JSValueConst obj) { return JS_GetOpaque(obj, minnet_generator_class_id); }

static inline MinnetGenerator* minnet_generator_data2(JSContext* ctx, JSValueConst obj) { return JS_GetOpaque2(ctx, obj, minnet_generator_class_id); }
