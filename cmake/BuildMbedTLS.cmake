macro(build_mbedtls)
  ...
  ExternalProject_Add(
    ...
    CMAKE_ARGS -DENABLE_TESTING=OFF -DENABLE_PROGRAMS=OFF "-DCMAKE_MODULE_PATH=${CMAKE_MODULE_PATH}" "-DCMAKE_SYSTEM_NAME=${CMAKE_SYSTEM_NAME}"
  ...
  add_custom_target(${MBEDTLS_TARGET_NAME}_clean COMMAND ${CMAKE_COMMAND} --build ${BINARY_DIR} --target clean WORKING_DIRECTORY "${BINARY_DIR}" COMMENT "Cleaning mbedtls"
                    VERBATIM)
