macro(build_libwebsockets)
  ...
  if(WITH_MBEDTLS)
    set(LIBWEBSOCKETS_ARGS
        "${LIBWEBSOCKETS_ARGS} -DLWS_MBEDTLS_LIBRARIES:STRING=${MBEDTLS_LIBRARIES} -DLWS_MBEDTLS_INCLUDE_DIRS:STRING=${MBEDTLS_INCLUDE_DIR}"
    )
  endif(WITH_MBEDTLS)
  if(WITH_SSL AND NOT WITH_MBEDTLS)
    set(LIBWEBSOCKETS_ARGS
        "${LIBWEBSOCKETS_ARGS} -DLWS_OPENSSL_LIBRARIES:STRING=${OPENSSL_LIBRARIES} -DLWS_OPENSSL_INCLUDE_DIRS:STRING=${OPENSSL_INCLUDE_DIR}"
    )
