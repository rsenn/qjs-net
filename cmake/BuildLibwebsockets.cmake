macro(build_libwebsockets)
  ...
  ExternalProject_Add(
    ...
    CMAKE_CACHE_ARGS
      "-DCMAKE_SYSTEM_INCLUDE_PATH:STRING=${CMAKE_SYSTEM_INCLUDE_PATH}" "-DCMAKE_SYSTEM_LIBRARY_PATH:STRING=${CMAKE_SYSTEM_LIBRARY_PATH}" "-DCMAKE_SYSTEM_PROGRAM_PATH:STRING=${CMAKE_SYSTEM_PROGRAM_PATH}" "-DCMAKE_SYSTEM_IGNORE_PATH:STRING=${CMAKE_SYSTEM_IGNORE_PATH}" "-DCMAKE_INCLUDE_PATH:STRING=${CMAKE_INCLUDE_PATH}" "-DCMAKE_LIBRARY_PATH:STRING=${CMAKE_LIBRARY_PATH}"
      "-DCMAKE_PROGRAM_PATH:STRING=${CMAKE_PROGRAM_PATH}" "-DCMAKE_IGNORE_PATH:STRING=${CMAKE_IGNORE_PATH}" "-DCMAKE_PREFIX_PATH:STRING=${CMAKE_PREFIX_PATH}" "-DCMAKE_MODULE_PATH:STRING=${CMAKE_MODULE_PATH}" "-DPKG_CONFIG_EXECUTABLE:FILEPATH=${PKG_CONFIG_EXECUTABLE}" "-DCMAKE_C_COMPILER:FILEPATH=${CMAKE_C_COMPILER}" "-DCMAKE_C_FLAGS:STRING=${CMAKE_C_FLAGS}"
      "-DCMAKE_VERBOSE_MAKEFILE:BOOL=${CMAKE_VERBOSE_MAKEFILE}" "-DCMAKE_INSTALL_RPATH:STRING=${MBEDTLS_LIBRARY_DIR}" "-DCOMPILER_IS_CLANG:BOOL=OFF" "-DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}" "-DCMAKE_LIBRARY_PATH:PATH=${CMAKE_LIBRARY_PATH};${CMAKE_CURRENT_BINARY_DIR}/mbedtls;${CMAKE_CURRENT_BINARY_DIR}/brotli"
