macro(build_libwebsockets)
  ...
  if(WITH_WOLFSSL)
    set(LIBWEBSOCKETS_ARGS -DLWS_WITH_WOLFSSL:BOOL=ON -DLWS_HAVE_EVP_PKEY_new_raw_private_key:BOOL=ON -DLWS_WITH_NETWORK:BOOL=OFF -DLWS_WITH_DIR:BOOL=OFF
      -DLWS_WITH_RANGES:BOOL=OFF -DLWS_WITH_JOSE:BOOL=OFF -DLWS_WITH_ACCESS_LOG:BOOL=OFF -DLWS_WITH_SSL:BOOL=OFF -DLWS_WITH_MBEDTLS:BOOL=OFF)
