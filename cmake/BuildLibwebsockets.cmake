macro(build_libwebsockets)
  ...
  set(LIBWEBSOCKETS_INCLUDE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/libwebsockets/include ${CMAKE_CURRENT_BINARY_DIR}/libwebsockets ${CMAKE_CURRENT_BINARY_DIR}/libwebsockets/include)
  ...
  if(WITH_WOLFSSL)
    set(LIBWEBSOCKETS_ARGS -DLWS_WITH_WOLFSSL:BOOL=ON -DLWS_HAVE_EVP_PKEY_new_raw_private_key:BOOL=ON -DLWS_WITH_NETWORK:BOOL=OFF -DLWS_WITH_DIR:BOOL=OFF -DLWS_WITH_RANGES:BOOL=OFF
                           -DLWS_WITH_JOSE:BOOL=OFF -DLWS_WITH_ACCESS_LOG:BOOL=OFF -DLWS_WITH_SSL:BOOL=OFF -DLWS_WITH_MBEDTLS:BOOL=OFF)
    ...
    if(WOLFSSL_FOUND)
      ...
      set(LIBWEBSOCKETS_ARGS ${LIBWEBSOCKETS_ARGS} -DLWS_WOLFSSL_LIBRARIES:STRING=${WOLFSSL_LIBRARIES} -DLWS_WOLFSSL_INCLUDE_DIRS:STRING=${WOLFSSL_INCLUDE_DIR})

    endif(WOLFSSL_FOUND)

  elseif(WITH_WOLFSSL)
    set(LIBWEBSOCKETS_ARGS ${LIBWEBSOCKETS_ARGS} -DLWS_ROLE_H2:BOOL=ON -DLWS_WITH_RANGES:BOOL=ON)
    if(WITH_SSL)
      set(LIBWEBSOCKETS_ARGS -DLWS_WITH_SSL:BOOL=ON -DLWS_HAVE_HMAC_CTX_new:STRING=1 -DLWS_HAVE_EVP_MD_CTX_free:STRING=1 -DLWS_WITH_WOLFSSL:BOOL=OFF -DLWS_WITH_MBEDTLS:BOOL=OFF)
      if(OPENSSL_LIBRARIES)
      ...
      if(OPENSSL_INCLUDE_DIR)
        set(LIBWEBSOCKETS_ARGS ${LIBWEBSOCKETS_ARGS} -DLWS_OPENSSL_INCLUDE_DIRS:STRING=${OPENSSL_INCLUDE_DIR} -DLWS_OPENSSL_INCLUDE_DIRS:STRING=${OPENSSL_INCLUDE_DIR})
      endif(OPENSSL_INCLUDE_DIR)
      if(OPENSSL_INCLUDE_DIRS)
        set(LIBWEBSOCKETS_ARGS ${LIBWEBSOCKETS_ARGS} -DLWS_OPENSSL_INCLUDE_DIRS:STRING=${OPENSSL_INCLUDE_DIRS} -DLWS_OPENSSL_INCLUDE_DIRS:STRING=${OPENSSL_INCLUDE_DIR})
  ...
  ExternalProject_Add(
    ...
    CMAKE_ARGS "-DCMAKE_C_COMPILER:FILEPATH=${CMAKE_C_COMPILER}"
               ...
               -DLWS_CTEST_INTERNET_AVAILABLE:BOOL=ON
               -DLWS_FALLBACK_GETHOSTBYNAME:BOOL=ON
               -DLWS_FOR_GITOHASHI:BOOL=OFF
               -DLWS_HTTP_HEADERS_ALL:BOOL=OFF
               -DLWS_IPV6:BOOL=OFF
               -DLWS_LINK_TESTAPPS_DYNAMIC:BOOL=OFF
               -DLWS_LOGS_TIMESTAMP:BOOL=ON
               -DLWS_LOG_TAG_LIFECYCLE:BOOL=ON
               -DLWS_PLAT_ANDROID:BOOL=OFF
               -DLWS_PLAT_FREERTOS:BOOL=OFF
               -DLWS_PLAT_OPTEE:BOOL=OFF
               ...
               -DLWS_WITHOUT_TEST_CLIENT:BOOL=OFF
               -DLWS_WITHOUT_TEST_PING:BOOL=OFF
               -DLWS_WITHOUT_TEST_SERVER:BOOL=OFF
               -DLWS_WITHOUT_TEST_SERVER_EXTPOLL:BOOL=OFF
               ...
               -DLWS_WITH_CYASSL:BOOL=OFF
               -DLWS_WITH_DEPRECATED_THINGS:BOOL=OFF
    ...
    CMAKE_CACHE_ARGS ${LIBWEBSOCKETS_ARGS} -DLWS_HAVE_LIBCAP:BOOL=FALSE -DLWS_WITH_PLUGINS_API:BOOL=${LWS_WITH_PLUGINS_API} -DLWS_WITH_PLUGINS:BOOL=${LWS_WITH_PLUGINS}
