macro(find_libwebsockets)
  ...
  if(NOT LIBWEBSOCKETS_FOUND)
    ...
    set(OPENSSL_SSL_LIBRARY "${OPENSSL_SSL_LIBRARY}" CACHE PATH "OpenSSL ssl library")
    set(OPENSSL_CRYPTO_LIBRARY "${OPENSSL_CRYPTO_LIBRARY}" CACHE PATH "OpenSSL crypto library")
    ...
    if(LIBWEBSOCKETS_LIBRARY_DIR)
      if(NOT LIBWEBSOCKETS_INCLUDE_DIRS)
	      string(REGEX REPLACE "/lib[^/]*$" "/include" LIBWEBSOCKETS_INCLUDE_DIRS "${LIBWEBSOCKETS_LIBRARY_DIR}")
