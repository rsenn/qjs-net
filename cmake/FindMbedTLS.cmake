macro(find_mbedtls)
 ...
 if(MBEDTLS_ROOT_DIR)
  ...
  find_package_handle_standard_args(mbedTLS FOUND_VAR MBEDTLS_FOUND REQUIRED_VARS MBEDTLS_INCLUDE_DIR MBEDTLS_LIBRARY MBEDTLS_CRYPTO_LIBRARY MBEDTLS_X509_LIBRARY MBEDTLS_LIBRARIES MBEDTLS_VERSION VERSION_VAR MBEDTLS_VERSION)
  ...
  if(MBEDTLS_FOUND)
    ...
    if(NOT TARGET mbedx509)
      ...
      set_target_properties(mbedx509 PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${MBEDTLS_INCLUDE_DIR}" INTERFACE_LINK_LIBRARIES mbedcrypto IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION "${MBEDTLS_X509_LIBRARY}")
    endif()
