macro(find_mbedtls)
  ...
  find_package_handle_standard_args(mbedTLS FOUND_VAR MBEDTLS_FOUND REQUIRED_VARS MBEDTLS_INCLUDE_DIR MBEDTLS_LIBRARY MBEDTLS_CRYPTO_LIBRARY MBEDTLS_X509_LIBRARY MBEDTLS_LIBRARIES
                                                                                  MBEDTLS_VERSION VERSION_VAR MBEDTLS_VERSION)

  if(MBEDTLS_FOUND)
    if(NOT TARGET mbedcrypto)
      add_library(mbedcrypto UNKNOWN IMPORTED)
      set_target_properties(mbedcrypto PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${MBEDTLS_INCLUDE_DIR}" IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION
    ...
    if(NOT TARGET mbedtls)
      ...
      set_target_properties(mbedtls PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${MBEDTLS_INCLUDE_DIR}" INTERFACE_LINK_LIBRARIES mbedx509 IMPORTED_LINK_INTERFACE_LANGUAGES "C"
