...
function(ABBREVIATE OUTVAR STR)
  if(ARGN)
    set(MAXLEN ${ARGN})
  else(ARGN)
    if(ENV{COLUMNS})
      set(MAXLEN ${ENV{COLUMNS}})
      math(EXPR MAXLEN "${MAXLEN} - 4")
    endif(ENV{COLUMNS})
  endif(ARGN)
  if(NOT MAXLEN OR MAXLEN LESS_EQUAL 0)
    set(MAXLEN 160)
  endif(NOT MAXLEN OR MAXLEN LESS_EQUAL 0)

  string(LENGTH SLEN "${STR}")

  if(SLEN GREATER MAXLEN)
    string(SUBSTRING "${S}" 0 "${MAXLEN}" S)
    set(S "${S} ...")
  endif(SLEN GREATER MAXLEN)
  set(${OUTVAR} "${S}" PARENT_SCOPE)
endfunction(ABBREVIATE OUTVAR STR)

function(PRINT_STR)
  abbreviate(S "${ARGN}")
  string(REPLACE "\n" "\\n" S "${S}")
  if(S STREQUAL "")
    string(SUBSTRING "${ARGN}" 0 160 S)
  endif(S STREQUAL "")
  message("${S}")
endfunction(PRINT_STR)
